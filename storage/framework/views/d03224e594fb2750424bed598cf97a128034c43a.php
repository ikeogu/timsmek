...
<body>
    <div class="wrapper">
        ...
        <div class="content-area">
            ...
            <a href="<?php echo e(route('orderDetails',['id' => $order->id])); ?>" class="btn-outline-info">previous page</a>
            </div>
                ...
                <div class="recipt-header card-header">
                    <div class="invoice">
                        ...
                        <div class="invoice-id">
                            ...
                            <div class="date">
                                <h6>Date Issued</h6>
                                <p><?php echo e(date('d/M/Y h:i:s',strtotime($order->paid_at))); ?></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="body-title row my-4">
                        <div class="billed col-sm-6 col-md-3 mx-auto">
                                <div class="order-id id-sm-show ml-5">
                                    <h6>Order ID</h6>
                                    <hr>
                                    <p><strong><?php echo e($order->order_id); ?></strong></p>
                                    <hr>
                                </div>
                            <ul>
                            <li><strong>Billed to:</strong></li>
                            <li><?php echo e($order->full_name); ?></li>
                            <li><?php echo e($order->address); ?></li>
                            <li><?php echo e($order->city. ' , ' .$order->state. ' , '. $order->country); ?></li>
                            </ul>
                        </div>
                        <div class="comp">
                            <ul>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($currency .' '.number_format(($item['item']['price']/100),2)); ?></td>
                    ...
                    <div class="receipt-footer row">
                        <div class="total text-center col-sm-12">
                            <h4>Invoice total</h4>
                        <h3><?php echo e($currency .' '.number_format($cart->totalPrice,2)); ?></h3>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH D:\Bitnami\wampstack-7.2\apache2\htdocs\LaravelProjects\timsmek\resources\views/pages/customer_invoice.blade.php ENDPATH**/ ?>